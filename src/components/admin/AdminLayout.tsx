...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navItems = [
    ...
    { path: '/admin/users', icon: Users, label: 'ইউজার' },
    { path: '/admin/withdrawals', icon: Wallet, label: 'উইথড্রয়াল' },
    { path: '/admin/payment-methods', icon: Wallet, label: 'পেমেন্ট মেথড' },
    { path: '/admin/social-links', icon: Share2, label: 'সোশ্যাল লিংক' },
    { path: '/admin/product-requests', icon: FileText, label: 'প্রোডাক্ট রিকোয়েস্ট' },
